        ...
        <ul class="p-2 grid w-full spacey-y-2">
            ...
            @if ($conversations)
                ...
                @foreach ($conversations as $key=> $conversation)
                    ...
                    class="py-3 hover:bg-gray-50 rounded-2xl dark:hover:bg-gray-700/70 transition-colors duration-150 flex gap-4 relative w-full cursor-pointer px-2 {{ $conversation->id == $selectedConversation?->id ? 'bg-blue-100/70' : '' }}">
                        
                        <a href="" class="shrink-0">
                            <x-avatar src="https://images.unsplash.com/profile-1446404465118-3a53b909cc82?ixlib=rb-0.3.5&q=80&fm=jpg&crop=faces&cs=tinysrgb&fit=crop&h=32&w=32&s=a2f8c40e39b8dfee1534eb32acfa6bc7-{{$key}}" />
                        </a>
                        ...
                        <aside class="grid grid-cols-12 w-full">
                            ...
                            <a href="{{route('chat', $conversation->id) }}" class="col-span-11 border-b pb-2 border-gray-200 relative overflow-hidden truncate leading-5 w-full flex-nowrap p-1">
                                ...
                                <div class="flex gap-x-2 items-center">
                                    ...
                                    <p class="grow truncate text-sm font-[100]"> {{ $conversation->messages?->last()?->body??'' }} </p>
                                ...
                                <x-dropdown align="right" width="48">
                                    ...
                                    <x-slot name="content">
                                        ...
                                        <div class="w-full p-1">
                                            ...
                                            <button 
                                                onclick="confirm('Voulez-vous supprimer?')||event.stopImmediatePropagation()"
                                                wire:click="deletedByUser('{{encrypt($conversation->id)}}')"
